...
if (!$conn) {
    ...
    print
        ...
        <form action="add_exception_horas_tabla.php" method="GET">
            ...
            <hr>
            <br>
           <input type="search" name="buscar_exception_obra" placeholder="Nombre de la obra" list="lista_exception_obras">
    ...
    print
        '</datalist> <br>
            <br><input type="text" name="cod_exception_works" placeholder="Codigo de la obra (automático)" readonly><br>
