...
if (!$conn) {
    ...
    $query = "select gastos.id, gastos.estado, users.name as 'user_name', users.last_name, users.email, works.name as 'work_name', works.code, gastos.fecha, gastos.tipo_gasto, gastos.importe, gastos.comentario, gastos.who_approve from gastos, users, works where users.id=gastos.user_id and gastos.work_id=works.id and gastos.user_id=$id_user";
